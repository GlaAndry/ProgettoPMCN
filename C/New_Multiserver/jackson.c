...
int main(){
    ...
    double E_t_q_s_1 = (Pq*E_s_s_1)/(1-rho_s);

    double E_n_v_1 = rho_v_1/(1-rho_v);
    double E_n_d_1 = rho_d_1/(1-rho_d);
    double E_n_s_1 = Pq*(rho_s_1/(1-rho_s)) + (m*rho_s_1);
    ...
    double E_t_q_s_2 = (Pq*E_s_s_2)/(1-rho_s);

    double E_n_v_2 = rho_v_2/(1-rho_v);
    double E_n_d_2 = rho_d_2/(1-rho_d);
    double E_n_s_2 = Pq*(rho_s_2/(1-rho_s)) + (m*rho_s_2);
    ...
    double E_t_q_s_3 = (Pq*E_s_s_3)/(1-rho_s);

    double E_n_v_3 = rho_v_3/(1-rho_v);
    double E_n_d_3 = rho_d_3/(1-rho_d);
    double E_n_s_3 = Pq*(rho_s_3/(1-rho_s)) + (m*rho_s_3);
