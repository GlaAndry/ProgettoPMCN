...
void calculate_batch(double time_next, struct state state, struct area area, struct last_state *last_state, int *i,
    ...
    E_n_serv_2[*i] = rho_service_2 / (1 - rho_service);
    ...
    E_n_serv_3[*i] = rho_service_3 / (1 - rho_service);
